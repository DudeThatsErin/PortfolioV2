...
export default function Home() {
  return (
    <main className="index-content" role="main" aria-label="Introduction">
      ...
      <p className="iam">I'm a <strong>Full-Stack Engineer</strong> who works on both front-end and back-end code. I have a passion for bot development and learning how to connect language learning models to those bots.</p>
